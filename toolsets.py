...
_HERMES_CORE_TOOLS = [
    ...
    # Grix backend APIs (gated on Grix adapter via check_fn)
    "grix_invoke",
]
...
TOOLSETS = {
    ...
    "grix": {
        "description": "Grix backend APIs - messaging, contacts, groups, admin",
        "tools": ["grix_invoke"],
        "includes": []
    },
