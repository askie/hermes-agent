...
SEND_MESSAGE_SCHEMA = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "target": {
                "type": "string",
                "description": "Delivery target. Format: 'platform' (uses home channel), 'platform:#channel-name', 'platform:chat_id', or 'platform:chat_id:thread_id' for threaded targets such as Telegram topics, Discord threads, and Grix threads. Grix also accepts a bound Hermes session key as the target body. Examples: 'telegram', 'telegram:-1001234567890:17585', 'discord:999888777:555444333', 'discord:#bot-home', 'slack:#engineering', 'signal:+155****4567', 'grix:g_1001:topic-a', 'grix:agent:main:grix:group:g_1001:topic-a'"
            },
            "message": {
                "type": "string",
