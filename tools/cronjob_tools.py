...
Important safety rule: cron-run sessions should not recursively schedule more cron jobs.""",
    "parameters": {
        ...
        "properties": {
            ...
            "deliver": {
                "type": "string",
                "description": "Delivery target: origin, local, grix, telegram, discord, slack, whatsapp, signal, weixin, matrix, mattermost, homeassistant, dingtalk, feishu, wecom, email, sms, bluebubbles, or platform:chat_id or platform:chat_id:thread_id for threaded targets. Examples: 'origin', 'local', 'telegram', 'telegram:-1001234567890:17585', 'discord:#engineering', 'grix:g_1001:topic-a'"
            },
            "skills": {
                "type": "array",
                "items": {"type": "string"},
